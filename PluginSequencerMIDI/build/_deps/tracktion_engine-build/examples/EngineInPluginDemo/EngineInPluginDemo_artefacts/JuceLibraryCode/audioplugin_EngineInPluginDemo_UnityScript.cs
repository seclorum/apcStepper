...
public class EngineInPluginDemoGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "EngineInPluginDemo"; } }
    public override string Description    { get { return "EngineInPluginDemo"; } }
    public override string Vendor         { get { return "yourcompany"; } }

    //==============================================================================
    [DllImport("EngineInPluginDemo")] static extern System.IntPtr getRenderCallback();

    [DllImport("EngineInPluginDemo")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("EngineInPluginDemo")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("EngineInPluginDemo")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("EngineInPluginDemo")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("EngineInPluginDemo")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("EngineInPluginDemo")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
